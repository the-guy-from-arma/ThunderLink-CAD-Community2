"""Authenticated FCX client. This module never imports or connects to CAD 1."""
...
class FcxClient:
    ...
    def resolve_account(
        self,
        *,
        community_user_id: int | str,
        display_name: str,
        bohemia_identity_id: str,
        verified: bool,
    ) -> dict[str, Any]:
        return self.request(
            "POST",
            "/api/v1/community/ravenhood/resolve",
            {
                "community_user_id": str(community_user_id),
                "display_name": str(display_name or "")[:200],
                "bohemia_identity_id": str(bohemia_identity_id or "")[:200],
